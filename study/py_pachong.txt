...
### xpath和lxml ##################################
# 用/按顺序，//任意节点开始，@跟标签属性有关(筛选[]或取值)，/text()获取文本
# 模块：lxml
from lxml import etree
element = etree.HTML("html字符串") # 输入的是requests.get()到的
element.xpath("xpath语法")   #定位

### bs4 ##################################
from bs4 import BeautifulSoup
Tag对象：带头尾的标签<title>xxx</title> 
BeautifulSoup对象：整个html，也可当作Tag对象；
-用法：soup=BeautifulSoup(html,'html.parser')，html是一整个网页；
